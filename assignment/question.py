...
row = 0
tempFilled = -1
#code to construct the grid according to seating
def construct(seatsGrid):
    ...
    for i in seatsGrid:
        ...
        seats.append(mat)
    return seats
#code to make pasenger demo sitting
...
#code to fill the passenger walkway seats first      
...
#code to fill the passenger window seat after filling aisel seats 
    ...
    while filled < number and filled != tempFilled:
        ...
        if seatsGrid[length-1][1] > row:
            ...
            if filled >= number:
                break
        row += 1
#code to make pasenger in middle seats
